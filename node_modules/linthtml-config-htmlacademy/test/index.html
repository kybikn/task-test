  ...
  <body class="index-page">
    ...
    <header class="header">
      <div class="container">
        <nav class="header__nav nav">
          <a class="nav__logo logo" href="index.html" aria-label="Обновить страницу">
          ...
          <ul class="nav__menu menu">
            <li class="menu__item menu__item--catalog">
              <button class="menu__link menu__link--catalog" type="button" aria-haspopup="true">Каталог товаров</button>
      ...
      <div class="container">
        <section class="logotypes">
          ...
          <ul class="logotypes__list">
            <li class="logotypes__item">
              <a class="logotypes__link" href="catalog.html" aria-label="Узнайть больше о компании">
        ...
        <div class="wrapper-about-contacts">
          ...
          <section class="contacts decor decor--contacts">
            ...
            <a class="contacts__map map" href="ouroffice.html" target="_blank" rel="noopener noreferrer" aria-label="Узнайте как добраться до офиса">
            ...
            <a class="contacts__more more-btn button-link button-link--wide" href="writeus.html" target="_blank" rel="noopener noreferrer">Напишите нам</a>
          </section>
        </div>
      </div>
    </main>
    ...
    <footer class="footer">
      <div class="footer-container container">
        <a class="footer__logo logo logo--footer" href="#" aria-label="Обновить страницу">
        ...
        <fieldset>
          ...
          <div class="write-us-form__fieldset-imitate">
            ...
            <p class="write-us-form__field write-us-form__field--text">
              <label class="write-us-form__label" for="write-us">Текст письма:</label>
              <textarea class="write-us-form__input write-us-form__input--textarea" id="write-us" name="message" wrap="soft" placeholder="В свободной форме"></textarea>
            </p>
          </div>
        </fieldset>
        <button class="write-us-form__submit more-btn button-submit" type="submit">Отправить</button>
      </form>
      <button class="modal__close close-btn close-btn--write-us" type="button" aria-label="Закрыть окно"></button>
    </section>
    ...
    <section class="modal modal--map">
      ...
      <button class="modal__close close-btn close-btn--map" type="button" aria-label="Закрыть окно"></button>
    </section>
